...
import AuthenticationPageContent from '../src/components/authenticationpagecontent';
...
describe('Testing Landing Page', () => {
    ...
    test('the body', () => {
      ...
      expect(paragraph.innerHTML).toBe('This shows either a login or register link or is used to logout immediately')
    })
})